      ...
      <div className="">
        ...
        <div className="space-y-4">
          <div className="relative" ref={dropdownRef}>
            <div 
              className={cn("flex items-center gap-2 px-2 py-2.5 border border-gray-300 rounded-sm cursor-pointer bg-white" , error && 'border-red-500')}
            ...
            >
              <div className="flex flex-wrap gap-2 flex-1">
                ...
                {selectedItems.length === 0 && (
                  <span className={cn('text-[#b2b6bd] text-sm')}>Select categories...</span>
                )}
              </div>
              <ChevronDown 
                size={20} 
                ...
                <div className="max-h-60 overflow-y-auto">
                  {isLoading ? (
                    ...
                    <>
                      ...
                      {!isLoading && filteredOptions.length === 0 && !showAddOption && (
                        <div className="p-4 text-center text-gray-500">
                          No options found
                        </div>
                      )}
