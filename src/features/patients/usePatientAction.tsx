...
export const usePatient = (
  ...
  // Add new Patient
  const addPatient = useCallback(async (patientData: Partial<PatientFormData>) => {
  ...
  const updatePatient = useCallback(async (PatientId: string | number, updateData: Partial<PatientFormData>) => {
...
const deletePatient = useCallback(async (PatientId: string | number, PatientName?: string) => {
